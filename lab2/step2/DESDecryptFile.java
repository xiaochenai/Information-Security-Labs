...
import javax.crypto.spec.*;
 ...
 public class DESDecryptFile{
   ...
   /*
    *  public DESDecryptFile(String,String,String)
    *  @PARAMS:
   ...
   public DESDecryptFile(String initKey, String clearText, String cipherText) throws Exception{
	 //translate the key  
   ...
   /*
    *  public DESDecryptFile(SecretKey,String,String)
    *  @PARAMS:
   ...
   public DESDecryptFile(SecretKey key, String clearText, String cipherText){
     this.key = key;
     this.clearText = clearText;
     this.cipherText = cipherText;
     // Create an 8-byte initialization vector
   ...
   /*
    *  public DESDecryptFile(String,String)
    *  @PARAMS:
    *  String clearText: name of file to store clear text output.
    *  String cipherText: name of file to store cipher text output.
    *  @OUTPUT:
   ...
   public DESDecryptFile(String clearText, String cipherText){
...
/*
   ...
   public void decrypt(){
	   try{
		   ...
		   OutputStream fout = new FileOutputStream("plaintextD-DES.txt");
   ...
   public static void main(String[] args) throws Exception{
	   //Key used for DES decryption	
	   String InitialKey = "2011BCSC";
	   //Export to "DESKey.hex"
	   ToHEX(InitialKey.getBytes(),"DESKey.hex");
	   
	   DESDecryptFile DES = new DESDecryptFile(InitialKey,"plaintext.txt","ciphertextDES.txt");
	   DES.decrypt();
   }
