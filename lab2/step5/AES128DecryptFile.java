...
import javax.crypto.spec.*;
 ...
 public class AES128DecryptFile{
   ...
   /*
    *  public AES128DecryptFile(String,String,String)
    *  @PARAMS:
    ...
    *  @OUTPUT:
    *    Returns: nothing.
    *    Creates: AES128DecryptFile object
    */
   
   public AES128DecryptFile(String initKey, String clearText, String cipherText) throws Exception{
	 //translate the key  
   ...
   /*
    *  public AES128DecryptFile(SecretKey,String,String)
    *  @PARAMS:
   ...
   public AES128DecryptFile(SecretKey key, String clearText, String cipherText){
     this.key = key;
     this.clearText = clearText;
     this.cipherText = cipherText;
     try {
   ...
   /*
    *  public AES128DecryptFile(String,String)
    *  @PARAMS:
    *  String clearText: name of file to store clear text output.
    *  String cipherText: name of file to store cipher text output.
    *  @OUTPUT:
    *    Returns: nothing.
    *    Creates: AES128DecryptFile object with AES as default algorithm, creating a AES key
    */
 
   public AES128DecryptFile(String clearText, String cipherText){
...
//		        stringBuilder.append( ls );
   ...
   public void decrypt(){
	   try{
		   ...
		   OutputStream fout = new FileOutputStream("plaintextD-AES.txt");
   ...
   public static void main(String[] args) throws Exception{ 
	   ...
	   AES128DecryptFile AES128 = new AES128DecryptFile(InitialKey,"plaintext.txt","ciphertextAES.txt");
	   AES128.decrypt();
   }
